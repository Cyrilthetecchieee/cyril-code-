...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "cyril_code.api.handlers.messages.MessagesHandler",
        "Cyril Code, VS Code, and JetBrains shaped requests",
    ...
    CapabilityContract(
        ...
        "cyril_code.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "cyril_code.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "cyril_code.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "cyril_code.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "cyril_code.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "cyril_code.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "cyril_code.core.anthropic.thinking",
    ...
    CapabilityContract(
        ...
        "cyril_code.core.anthropic.tools",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "cyril_code.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "cyril_code.api.optimization_handlers",
        "Cyril Code probe/title/suggestion/filepath requests",
    ...
    CapabilityContract(
        ...
        "cyril_code.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "cyril_code.config.settings.Settings",
        "process env, user env file, repo env file, CYRIL_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "cyril_code.config.settings.Settings",
        "retired ENABLE_MODEL_THINKING or tier override in an CYRIL-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "cyril_code.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "cyril_code.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "cyril_code.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "cyril_code.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "cyril_code.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "cyril_code.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "cyril_code.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "cyril_code.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "cyril_code.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "codex_cli_drop_in",
        "drop_in_codex_replacement",
        "cyril_code.cli.launchers.codex",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "cyril_code.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and CYRIL child-process environment",
        "Anthropic Messages provider with an CYRIL-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "cyril_code.providers.runtime and cyril_code.messaging.platforms.factory",
