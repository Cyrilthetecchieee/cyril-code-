...
from beast.core.anthropic import anthropic_error_payload
from beast.core.diagnostics import (
    redacted_exception_traceback,
    safe_exception_message,
)
from beast.core.openai_responses import openai_error_payload
...
def create_app(services: ApiServices) -> FastAPI:
    ...
    app = FastAPI(title="Beast Proxy", version=package_version())
