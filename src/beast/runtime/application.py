...
import beast.cli.managed as cli_managed
import beast.messaging.session as messaging_session
import beast.messaging.workflow as messaging_workflow_module
...
from beast.application.model_metadata import ProviderModelRefreshResult
from beast.application.ports import StopResult
from beast.config.admin.persistence import (
    PreparedAdminUpdate,
...
from beast.config.model_refs import parse_provider_type
from beast.config.paths import messaging_state_dir_path
from beast.config.server_urls import local_admin_url, local_proxy_root_url
from beast.config.settings import Settings, get_settings
from beast.messaging.platforms import factory as messaging_platform_factory
from beast.messaging.platforms.factory import MessagingPlatformOptions
...
class ApplicationRuntime:
    ...
    async def start(self) -> None:
        if self._started:
            return
        logger.info("Starting Beast Proxy...")
        try:
