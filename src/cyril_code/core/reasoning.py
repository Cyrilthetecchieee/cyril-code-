...
class ReasoningEffort(StrEnum):
    """Named reasoning effort understood at the CYRIL application boundary."""
    ...
    def budget_tokens(self) -> int:
        """Return CYRIL's numeric token budget for this effort."""
...
class ReasoningPolicy:
    ...
    def numeric_budget_tokens(self) -> int | None:
        """Express this intent as an exact or CYRIL-mapped numeric budget."""
