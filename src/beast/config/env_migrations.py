"""One-time dotenv migrations for BEAST-owned config files."""
...
LEGACY_OPENCODE_SMOKE_MODEL_ENV = "BEAST_SMOKE_MODEL_OPENCODE"
OPENCODE_ZEN_SMOKE_MODEL_ENV = "BEAST_SMOKE_MODEL_OPENCODE_ZEN"
...
def explicit_env_file_migration_warning(
    ...
    return (
        f"Explicit BEAST_ENV_FILE {path} uses retired settings. "
        f"{'; '.join(actions)}; "
