"""Implementations for installed Beast commands."""
...
from beast.runtime.bootstrap import build_asgi_app
...
class ServerSupervisor:
    """Own one BEAST server lifecycle, including config-driven restarts."""
    ...
    def run(self, *, open_admin_browser: bool | None = None) -> None:
        ...
        with self._lock:
            self._run_scheduled = False
            if self._running:
                raise RuntimeError("The BEAST server supervisor is already running.")
