...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "beast.api.handlers.messages.MessagesHandler",
        "Beast, VS Code, and JetBrains shaped requests",
    ...
    CapabilityContract(
        ...
        "beast.api.handlers.responses.ResponsesHandler",
    ...
    CapabilityContract(
        ...
        "beast.api.dependencies.require_proxy_auth",
    ...
    CapabilityContract(
        ...
        "provider_runtime",
        "provider_matrix",
        "beast.runtime.provider_manager.ProviderRuntimeManager",
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "beast.application.routing.ModelRouter",
    ...
    CapabilityContract(
        ...
        "beast.providers.runtime.ProviderRuntime",
    ...
    CapabilityContract(
        ...
        "beast.core.failures.ExecutionFailure",
    ...
    CapabilityContract(
        ...
        "subagent_control",
        "beast.core.anthropic.streaming.AnthropicStreamLedger",
    ...
    CapabilityContract(
        ...
        "beast.api.optimization_handlers",
        "Beast probe/title/suggestion/filepath requests",
    ...
    CapabilityContract(
        ...
        "beast.core.anthropic.get_token_count",
    ...
    CapabilityContract(
        ...
        "beast.config.settings.Settings",
        "process env, user env file, repo env file, BEAST_ENV_FILE",
    ...
    CapabilityContract(
        ...
        "removed_env_migration",
        "beast.config.settings.Settings",
        "retired ENABLE_MODEL_THINKING or tier override in an BEAST-owned dotenv",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "beast.providers.admission.ProviderAdmissionController",
    ...
    CapabilityContract(
        ...
        "lmstudio_messages",
        "lmstudio_endpoint",
        "beast.providers.lmstudio.LMStudioProvider",
    ...
    CapabilityContract(
        ...
        "llamacpp_endpoint",
        "beast.providers.openai_chat.OpenAIChatProvider",
    ...
    CapabilityContract(
        ...
        "provider_matrix",
        "beast.providers.open_router.OpenRouterProvider",
    ...
    CapabilityContract(
        ...
        "beast.messaging.workflow.MessagingWorkflow",
    ...
    CapabilityContract(
        ...
        "tree_threading",
        "tree_threading",
        "beast.messaging.trees.TreeQueueManager",
    ...
    CapabilityContract(
        ...
        "restart_restore",
        "restart_restore",
        "beast.messaging.session.SessionStore",
        "stored tree JSON",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "beast.messaging.voice.Transcriber",
    ...
    CapabilityContract(
        ...
        "claude_cli_drop_in",
        "claude_cli_drop_in",
        "beast.cli.managed.session.ManagedClaudeSession",
    ...
    CapabilityContract(
        ...
        "pi_cli_integration",
        "pi_cli_integration",
        "beast.cli.launchers.pi",
        "Pi CLI binary, bundled extension, and BEAST child-process environment",
        "Anthropic Messages provider with an BEAST-scoped live model catalog",
    ...
    CapabilityContract(
        ...
        "beast.providers.runtime and beast.messaging.platforms.factory",
