"""Managed Cyril Code diagnostic classification."""
...
class ManagedClaudeStderrDiagnostics:
    """Classified stderr lines from one managed Cyril Code invocation."""
...
def classify_managed_claude_stderr(
    ...
    """Classify known benign Cyril Code diagnostics separately from failures."""
