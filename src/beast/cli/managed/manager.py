"""Managed Beast session pool for messaging."""
...
from beast.cli.claude_env import CLAUDE_BINARY_NAME
...
class ManagedClaudeSessionManager:
    """
    Manages multiple Beast sessions for parallel conversation processing.
