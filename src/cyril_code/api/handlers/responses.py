...
from cyril_code.application.execution import ProviderExecutor
...
from cyril_code.core.anthropic import MessagesRequest
...
from cyril_code.core.openai_responses import (
    ...
    async def create(
        ...
        if request_data.stream is False:
            raise InvalidRequestError(
                "CYRIL /v1/responses supports streaming only; omit stream or set stream=true."
            )
