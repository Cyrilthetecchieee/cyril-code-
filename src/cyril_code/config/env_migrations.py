"""One-time dotenv migrations for CYRIL-owned config files."""
...
LEGACY_OPENCODE_SMOKE_MODEL_ENV = "CYRIL_SMOKE_MODEL_OPENCODE"
OPENCODE_ZEN_SMOKE_MODEL_ENV = "CYRIL_SMOKE_MODEL_OPENCODE_ZEN"
...
def explicit_env_file_migration_warning(
    ...
    return (
        f"Explicit CYRIL_ENV_FILE {path} uses retired settings. "
        f"{'; '.join(actions)}; "
