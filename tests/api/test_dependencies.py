...
from cyril_code.api.dependencies import (
    get_services,
    get_settings,
    require_proxy_auth,
    resolve_provider,
...
from cyril_code.application.ports import RequestRuntimeLease
...
def test_resolve_provider_uses_retained_lease_and_logs_first_initialization() -> None:
    ...
    with patch("cyril_code.api.dependencies.logger.info") as log_info:
