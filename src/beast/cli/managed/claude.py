"""Managed Beast task command, environment, and stdout parsing."""
...
from beast.cli.claude_env import (
    CLAUDE_BINARY_NAME,
...
class ManagedClaudeTaskRequest:
    """One prompt execution request for a managed Beast subprocess."""
...
class ManagedClaudeConfig:
    """Configuration for a managed Beast subprocess."""
...
class ManagedClaudeParseState:
    """Mutable stdout parser state for one managed Beast task run."""
...
def build_managed_claude_invocation(
    *,
    ...
    """Build a Beast stream-json subprocess invocation."""
...
def build_managed_claude_env(
    *,
    ...
    """Return a Beast task environment that targets the local proxy."""
...
def build_managed_claude_command(
    *,
    ...
    """Return the Beast stream-json command for a managed task."""
...
def parse_managed_claude_stdout_line(
    ...
    """Parse one Beast stream-json stdout line."""
...
def extract_managed_claude_session_id(event: Any) -> str | None:
    """Extract a Beast session ID from supported stream-json event shapes."""
