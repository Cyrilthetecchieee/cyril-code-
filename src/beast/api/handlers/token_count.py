...
from beast.application.errors import ApplicationError
from beast.application.execution import TokenCounter
    ...
    def count(
        ...
        with logger.contextualize(request_id=request_id):
            try:
                ...
                trace_event(
                    stage="routing",
                    event="beast.api.route.resolved",
                    source="api",
                ...
                trace_event(
                    stage="ingress",
                    event="beast.api.count_tokens.completed",
                    source="api",
                    request_id=request_id,
