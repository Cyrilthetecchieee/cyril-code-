"""Platform-neutral lifecycle for the BEAST desktop shell."""
...
from beast.config.paths import config_dir_path
...
class DesktopController:
    """Coordinate one tray loop with one in-process BEAST server owner."""
    ...
    def run(self) -> None:
        """Run the tray on this thread and the BEAST server on its owned worker."""
...
def launch_desktop(tray_factory: DesktopTrayFactory) -> None:
    """Start the singleton desktop host or focus the already running BEAST UI."""
