...
from cyril_code.config.provider_catalog import GITHUB_MODELS_DEFAULT_BASE
...
from cyril_code.providers.github_models.client import GITHUB_MODELS_CATALOG_URL
