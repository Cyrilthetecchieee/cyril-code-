...
from beast.api.optimization_handlers import (
    try_filepath_mock,
    try_optimizations,
...
class TestTryPrefixDetection:
    ...
    def test_enabled_and_match_returns_response(self):
        ...
        with (
            ...
            patch("beast.api.optimization_handlers.logger.info") as mock_log_info,
        ):
...
class TestTrySuggestionSkip:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "beast.api.optimization_handlers.is_suggestion_mode_request",
            return_value=True,
        ):
...
class TestTryFilepathMock:
    def test_disabled_returns_none(self):
        ...
        with patch(
            "beast.api.optimization_handlers.is_filepath_extraction_request",
    ...
    def test_enabled_and_match_returns_response(self):
        ...
        with (
            ...
            patch(
                "beast.api.optimization_handlers.extract_filepaths_from_command",
                return_value="a.txt\nb.txt",
            ),
        ):
