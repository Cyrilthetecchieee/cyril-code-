"""Managed Cyril Code task command, environment, and stdout parsing."""
...
from cyril_code.cli.claude_env import (
    CLAUDE_BINARY_NAME,
...
class ManagedClaudeTaskRequest:
    """One prompt execution request for a managed Cyril Code subprocess."""
...
class ManagedClaudeConfig:
    """Configuration for a managed Cyril Code subprocess."""
...
class ManagedClaudeParseState:
    """Mutable stdout parser state for one managed Cyril Code task run."""
...
def build_managed_claude_invocation(
    *,
    ...
    """Build a Cyril Code stream-json subprocess invocation."""
...
def build_managed_claude_env(
    *,
    ...
    """Return a Cyril Code task environment that targets the local proxy."""
...
def build_managed_claude_command(
    *,
    ...
    """Return the Cyril Code stream-json command for a managed task."""
...
def parse_managed_claude_stdout_line(
    ...
    """Parse one Cyril Code stream-json stdout line."""
...
def extract_managed_claude_session_id(event: Any) -> str | None:
    """Extract a Cyril Code session ID from supported stream-json event shapes."""
