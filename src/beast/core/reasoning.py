...
class ReasoningEffort(StrEnum):
    """Named reasoning effort understood at the BEAST application boundary."""
    ...
    def budget_tokens(self) -> int:
        """Return BEAST's numeric token budget for this effort."""
...
class ReasoningPolicy:
    ...
    def numeric_budget_tokens(self) -> int | None:
        """Express this intent as an exact or BEAST-mapped numeric budget."""
