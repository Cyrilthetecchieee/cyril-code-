...
from cyril_code.application.errors import ApplicationError
from cyril_code.application.execution import TokenCounter
    ...
    def count(
        ...
        with logger.contextualize(request_id=request_id):
            try:
                ...
                trace_event(
                    stage="routing",
                    event="cyril_code.api.route.resolved",
                    source="api",
                ...
                trace_event(
                    stage="ingress",
                    event="cyril_code.api.count_tokens.completed",
                    source="api",
                    request_id=request_id,
