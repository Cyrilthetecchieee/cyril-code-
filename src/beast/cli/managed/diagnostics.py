"""Managed Beast diagnostic classification."""
...
class ManagedClaudeStderrDiagnostics:
    """Classified stderr lines from one managed Beast invocation."""
...
def classify_managed_claude_stderr(
    ...
    """Classify known benign Beast diagnostics separately from failures."""
