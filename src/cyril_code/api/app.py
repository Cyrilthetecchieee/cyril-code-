...
from cyril_code.core.anthropic import anthropic_error_payload
from cyril_code.core.diagnostics import (
    redacted_exception_traceback,
    safe_exception_message,
)
from cyril_code.core.openai_responses import openai_error_payload
from cyril_code.core.trace import (
...
def create_app(services: ApiServices) -> FastAPI:
    ...
    app = FastAPI(title="Cyril Code Proxy", version=package_version())
