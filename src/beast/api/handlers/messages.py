...
from beast.api.detection import is_safety_classifier_request
from beast.api.optimization_handlers import try_optimizations
from beast.api.request_errors import (
    http_status_for_unexpected_api_exception,
    log_unexpected_api_exception,
    require_non_empty_messages,
    unexpected_http_exception,
)
from beast.api.request_ids import new_request_id
...
from beast.api.web_tools.request import (
    is_web_server_tool_request,
    unsupported_server_tool_error,
)
from beast.api.web_tools.streaming import stream_web_server_tool_response
from beast.application.errors import ApplicationError, InvalidRequestError
from beast.application.execution import ProviderExecutor, TokenCounter
from beast.application.ports import ProviderResolver
from beast.application.routing import ModelRouter, RoutedMessagesRequest
...
from beast.core.diagnostics import safe_exception_message
from beast.core.failures import ExecutionFailure, find_execution_failure
from beast.core.reasoning import ReasoningControl, ReasoningPolicy
from beast.core.trace import trace_event
...
class MessagesHandler:
    ...
    async def _to_public_response(
        ...
        *,
        ...
        if not stream:
            # Non-streaming clients (e.g. Beast utility calls) need a
    ...
    def _intercept_web_server_tool(
        ...
        trace_event(
            stage="routing",
            event="beast.api.optimization.web_server_tool",
            source="api",
            model=routed.resolved.original_model,
        )
    ...
    def _intercept_local_optimization(
        ...
        trace_event(
            stage="routing",
            event="beast.api.optimization.short_circuit",
            source="api",
            model=routed.resolved.original_model,
        )
