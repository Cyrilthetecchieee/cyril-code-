"""Managed Cyril Code session pool for messaging."""
...
from cyril_code.cli.claude_env import CLAUDE_BINARY_NAME
...
class ManagedClaudeSessionManager:
    """
    Manages multiple Cyril Code sessions for parallel conversation processing.
